...
const skillSections = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Expo",              icon: FaBox,              color: "text-blue-600" },
      { name: "Expo SDK 54",       icon: FaBox,              color: "text-purple-600" },
    ]
  },
  {
    title: "Backend",
    skills: [
      ...
      { name: "Axios",             icon: FaGlobe,            color: "text-purple-600" },
      { name: "Resend",            icon: FaEnvelope,         color: "text-red-600" },
    ]
  },
  {
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "AI & ML",           icon: GiArtificialIntelligence, color: "text-purple-600" }
    ]
  },
  {
    title: "Soft Skills",
    skills: [
      { name: "Leadership",        icon: FaHeadset,          color: "text-amber-600" },
...
export default function Skills() {
  return (
    <section id="skills" className="relative py-24 px-6 bg-linear-to-br from-base-200/50 via-base-100 to-base-200/50 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        {skillSections.map((section, sectionIndex) => (
          <div key={sectionIndex} className="mb-20 last:mb-0">
            <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-transparent bg-linear-to-r from-primary to-accent bg-clip-text mb-8 sm:mb-10 md:mb-12 text-center tracking-tight">
              {section.title}
            </h3>
              ...
              {section.skills.map((skill, i) => (
                ...
                >
                  {skill.type === "local" ? (
                    ...
                    <div className="h-full aspect-square bg-linear-to-br from-base-100 to-base-200/50 rounded-2xl p-3 sm:p-4 md:p-6 flex flex-col items-center justify-center shadow-lg border-2 border-primary/10 group-hover:border-primary/40 group-hover:shadow-2xl group-hover:bg-linear-to-br group-hover:from-primary/5 group-hover:to-accent/5 transition-all duration-400 hover:scale-110">
                      <skill.icon
